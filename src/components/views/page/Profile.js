...
export class Profile extends Component {
    ...
    render() {
        ...
        const address = (data.personState.data) ? (this.state) ? (this.state.technician_address) ? (this.state.technician_address).length > 20 ? (this.state.technician_address).slice(0, 20) + " ..." : (this.state.technician_address) : "Your Location / Plan" : "Your Location / Plan" : "Your Location / Plan";
